...
<form action="input-datadiri-edit.php" method="POST">
    ...
    <input class="form-control" value="<?php echo $row["nis"]; ?>"type="number" name="nis" placeholder="Ex.12333122" readonly/><br>

    <label for="nama">Nama Lengkap :</label>
    <input class="form-control" value="<?php echo $row["namalengkap"]; ?>"type="text" name="nama" placeholder="Ex.Sintha Nur Wulan"/><br>

    <label for="tanggal_lahir">Tanggal Lahir :</label><br>
    <input class="form-control" value="<?php echo $row["tanggal_lahir"]; ?>"type="date" name="tanggal_lahir"/><br>

    <label for="nilai">Nilai:</label><br>
    <input class="form-control"nvalue="<?php echo $row["nilai"]; ?>"type="number" name="nilai" placeholder="Ex.80.56"/><br>
