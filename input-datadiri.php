<?php 
      ...
      echo "<hr>";
      echo "<a class='btn btn-warning btn-sm' href='input-datadiri-tambah.php'>Tambah Data</a>";
      echo " - ";
      echo "<a class= 'btn btn-success btn-sm' href='input-datadiri-pdf.php'>Download PDF</a>";
      echo "<hr>";
      ...
      while($row = mysqli_fetch_array($data)){
            $tabledata .= "
                  <tr>
                        ...
                        <td>".$row["nilai"]."</td>
                        <td>
                              <a class= 'btn btn-info btn-sm' href='input-datadiri-edit.php?nis=".$row["nis"]."'>Edit</a>
                              &nbsp;-&nbsp;
